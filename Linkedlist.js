...
//     reverse() {
//         let prev = null; // Starts as null (end of the reversed list)
//         let current = this.head; // Start from the head of the original list
...
//         // Swap head and tail
//         this.tail = this.head; // Original head becomes the new tail
//         this.head = prev; // New head is the last node processed (prev)
//     }
    ...
    deleteNode(value){
        ...
        while(crnt){
            ...
            if(crnt.value==value){
                ...
                if(crnt == this.head) this.head = crnt.next;
                if(crnt == this.tail) this.tail = crnt.prev;
            ...
            crnt = crnt.next ;
                ...
                let temp = null;         // Temporary variable to hold the swapped pointer
...
console.log("MiddleElement:",list.middle());
